...
import { createProductionBatch, addProductsToBatch, updateProductDetailsInBatch, getLatestProductionBatchNumber, getProductionBatches} from '../Controllers/productionBatchController.js';
...
router.post('/production-batch/add', createProductionBatch);

...
function AddCustomer() {
  ...
  const [customerCode] = useState("#0001254632");
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mt-4">
        <div>
          ...
          <div>
            ...
            <div className="mb-4">
              <label className="block text-gray-700 mb-2">Customer Code</label>
              ...
              <p className="text-sm text-gray-500 mt-2">
                This is customer code auto-generated by the system. It can be
                changed at any time.
              </p>
            </div>
          </div>
